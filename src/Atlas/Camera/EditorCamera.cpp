...
void EditorCamera::OnUpdate(bool is_update) {
    const glm::vec2& mouse{Input::GetMouseX(), Input::GetMouseY()};
    glm::vec2 delta = (mouse - m_InitMousePos) * 0.003f;
    m_InitMousePos  = mouse;
    if (is_update) {
...
void EditorCamera::OnEvent(Event& e) {
    ...
    dispatcher.Dispatch<MouseScrolledEvent>(BIND_CALLBACK_FUNC(EditorCamera::OnMouseScroll));
}
